...
export default function CardCollaborationPanel({ cardId, canEdit, candidates, onOpenCard, onDescriptionRestore, showExisting = true, showRelationCreator = canEdit }: { cardId: string; canEdit: boolean; candidates: Candidate[]; onOpenCard: (cardId: string) => void; onDescriptionRestore: (description: string) => void; showExisting?: boolean; showRelationCreator?: boolean }) {
