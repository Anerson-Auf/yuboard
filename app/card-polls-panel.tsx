...
export default function CardPollsPanel({ cardId, canEdit, showPolls = true, showCreate = canEdit }: { cardId: string; canEdit: boolean; showPolls?: boolean; showCreate?: boolean }) {
