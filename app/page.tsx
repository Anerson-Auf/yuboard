...
const boardViewToggleOptions = [{ value: 'standard', label: 'Ряд' }, { value: 'freeform', label: 'Свободно', title: 'Колонки можно свободно двигать; Shift включает привязку к сетке' }] as const;
    ...
    {view === 'home' ? <section className="home-screen workspace-cards-screen">
      ...
      <section className="board-header">
        ...
        <div className="board-tools">
          ...
          <SegmentedToggle className="board-content-toggle" label="Представление задач" options={boardContentToggleOptions} value={boardContentMode} onChange={(next) => setBoardContentMode(next as BoardContentMode)} />
          {!isPublicViewer && boardContentMode === 'columns' && <SegmentedToggle className="board-view-toggle" label="Режим расположения колонок" options={boardViewToggleOptions} value={boardViewMode} onChange={(next) => changeBoardViewMode(next as BoardViewMode)} />}
