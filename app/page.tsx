  ...
  return <main className={`app-shell dark ${view === 'home' ? 'home-mode' : ''} ${isPublicViewer ? 'public-viewer' : ''} ${boardBackgroundUrl && view === 'board' && !boardBackgroundFailed ? 'has-board-background' : ''} ${usesDefaultBoardBackground ? 'default-board-background' : ''}`} style={boardBackgroundStyle}>
    <header className="topbar">
      ...
      <div className="top-actions">
        ...
        {view === 'board' && canManageBoardAdministration && boardId && <button className="top-utility-button" type="button" onClick={() => setAutomationsOpen(true)} aria-label="Автоматизации">↻ <span>Авто</span></button>}
    ...
    {view === 'home' ? <section className="home-screen workspace-cards-screen">
      ...
      <section className="board-header">
        ...
        <div className="board-tools">
          ...
          {canManageBoardAdministration && <button className="board-icon-button" type="button" title="Собрать changelog" aria-label="Собрать changelog" onClick={openChangelog}>✦</button>}
