    ...
    {view === 'home' ? <section className="home-screen workspace-cards-screen">
      ...
      <section className="board-header">
        ...
        <div className="board-tools">
          ...
          {!isPublicViewer && <button className={`board-icon-button ${isBulkMode ? 'active-filter' : ''}`} type="button" title="Массовые действия" aria-label="Массовые действия" onClick={() => { setBulkMode((current) => !current); setBulkCardIds([]); }}><span aria-hidden="true">☷</span></button>}
